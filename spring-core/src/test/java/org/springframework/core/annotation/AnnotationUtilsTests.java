...
public class AnnotationUtilsTests {
    ...
    static void clearCache(String... cacheNames) {
        ...
        //for (String cacheName : cacheNames) { getCache(cacheName).clear(); }
    }
    ...
    @Test
    // assertTrue(bridgeMethod.isBridge()); --> Bridge Method(桥接方法)(http://berdy.iteye.com/blog/810488)
    public void findMethodAnnotationOnBridgeMethod() throws Exception {
        ...
        System.out.println(bridgeMethod.isBridge());
    ...
    public void findMethodAnnotationOnBridgedMethod() throws Exception {
        ...
        System.out.println(bridgedMethod.isBridge());
    ...
    public void findClassAnnotationFavorsMoreLocallyDeclaredComposedAnnotationsOverInheritedComposedAnnotations() {
        ...
        assertNotNull(component);
        assertEquals("meta2", component.value());
        System.out.println("findClassAnnotationFavorsMoreLocallyDeclaredComposedAnnotationsOverInheritedComposedAnnotations".length());
    }
    ...
    public void getAnnotationAttributesWithAttributeAliases() throws Exception {
        ...
        Method method2 = WebController.class.getMethod("handleMappedWithValueAttribute2");
        WebMapping webMapping2 = method2.getAnnotation(WebMapping.class);

        assertEquals(webMapping, webMapping2);
        System.out.println(webMapping == webMapping2);
        System.out.println(webMapping.hashCode());
        System.out.println(webMapping2.hashCode());
        System.out.println(webMapping.equals(webMapping2));
    ...
    public static class SimpleFoo extends Foo<String> {
        ...
        public void something(final String arg) {
            //super.something(arg);
            System.out.println("SimpleFoo..." + arg.toString());
        }
    }
    ...
    public void testOverride() throws Exception {
        Method something = SimpleFoo.class.getMethod("something", String.class);
        System.out.println(something.getDeclaringClass());

        new SimpleFoo().something("ttttttttt");


        Method[] declaredMethods = SimpleFoo.class.getDeclaredMethods();
        System.out.println(declaredMethods.length);
        Method[] methods = SimpleFoo.class.getMethods();
        System.out.println(methods.length);
        Method enclosingMethod = F.class.getEnclosingMethod();
        System.out.println(enclosingMethod);

        stream(declaredMethods).forEach(method -> System.out.println(method.getName()+" - " + method.getParameters()[0].getType()));
    }
    ...
    public void Inherited() throws Exception {
        WebMapping base = BaseController.class.getAnnotation(WebMapping.class);
        WebMapping web = WebController.class.getAnnotation(WebMapping.class);
        assertNotEquals(base, web);
        System.out.println(base.equals(web));
    }


    @WebMapping(value = "/test2", name = "foo2")
    static class BaseController {

    }

    @Component("webController")
    static class WebController extends BaseController {
        ...
        @WebMapping(value = "/test", name = "foo")
        public void handleMappedWithValueAttribute2() {
        }
